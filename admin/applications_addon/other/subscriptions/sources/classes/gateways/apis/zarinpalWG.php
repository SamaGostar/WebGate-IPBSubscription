...
/**
 * Product Title:		zarinpalwg gateway
 * Product Version:		1.0
 * Author:				mr.wosi
...
class gatewayApi_zarinpalwg extends apiCore
{
	/**
	 * Identify this class
	 *
	...
	function makeFormAction_normal()
	{
		...
		if(!$merchantID)
			ipsRegistry::getClass('output')->showError( 'zarinpalwg_novender', 'Novender_id', FALSE, '', 403 );
	...
	{
		$this->db_info = array( 'human_title'         => 'zarinpalwg',
								'human_desc'		  => 'zarinpalwg gateway for iranian.',
								'module_name'         => self::API_NAME,
								'allow_creditcards'   => 1,
								'allow_auto_validate' => 1,
								'default_currency'    => 'IRR' );
																   
		$this->install_lang = array( 'zarinpalwg_novender' => 'Please report to admin' );
	}
}